...
public class RTreeSerializer {
	 ...
	 */
	public void writeToStream(final RandomAccessFile randomAccessFile) throws SpatialIndexException {
		
		nodesQueue.clear();
		
		try {
			// Write the magic bytes
			randomAccessFile.write(Const.MAGIC_BYTES_SPATIAL_RTREE_INDEX);
